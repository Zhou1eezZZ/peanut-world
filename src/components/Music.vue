<template>
    <div class="container">
        <div v-for="(val, key) in VOICE_MAP" :key="`level${key}`" class="piano-row">
            <span
        ...
        <el-divider />
        <el-button type="text" @click="diyPlay(XIAOXINGYUN)">
            点击播放小幸运
        </el-button>
        <el-button type="text" @click="diyPlay(DITIEDENGDAI)">
            点击播放地铁等待
        </el-button>
    </div>
</template>
